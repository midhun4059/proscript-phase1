...
const PrescriptionPrint: React.FC<Props> = ({ data, sectionsPerPage = 5 }) => {
  const buildSections = () => {
    ...
    if (data.showLabInvestigations !== false) {
      sections.push({
        id: "lab",
    ...
    if (data.showRadiologyInvestigations !== false) {
      sections.push({
        id: "radio",
  ...
  return (
    <div id="prescription-root" className="print-only">
          ...
          {data.letterhead && (
            <img
              ...
              style={{
                ...
                zIndex: -1,
                opacity: 0.08,
                filter: "grayscale(1) brightness(1.05) saturate(0.4)",
                pointerEvents: "none",
              }}
            />
          )}
